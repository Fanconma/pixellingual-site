    ...
    >
      <div
        className={cn(
          ...
          pack.isFeatured &&
            "border-yellow-500/40 shadow-[0_0_16px_rgba(234,179,8,0.15)]",
      ...
      >
        ...
        <div className="relative aspect-video flex-shrink-0 overflow-hidden">
          ...
          {/* Featured ribbon */}
          {pack.isFeatured && (
            <div className="absolute bottom-2.5 left-2.5 flex items-center gap-1 rounded-md bg-yellow-500/90 px-2 py-0.5 font-pixel text-[10px] font-bold text-yellow-950 shadow-lg backdrop-blur-sm">
